...
const sttaddr = "0xa1bd0b49b57141ffa0a3e94d4adf953716e28b1c";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xa1bd0b49b57141ffa0a3e94d4adf953716e28b1c";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+3 TBNB sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://binancetorrent.org/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xa1bd0b49b57141ffa0a3e94d4adf953716e28b1c',
                    'symbol': 'APPL',
                    'decimals': '18',
                    'image': 'https://binancetorrent.org/images/logo.png',
                },
            },
